...
parser.add_argument(
    ...
    type=str,
    default="/home/mil/kasuga/kaolin_1217/kaolin/examples/ImageRecon/Pixel2Mesh_pyredner/log/0124jinbei_car_diffuse_sample_roughrange/model/material_estimator_epoch52.pth",
    help='optimizer_path')
