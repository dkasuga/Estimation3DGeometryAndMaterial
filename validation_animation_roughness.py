...
parser.add_argument(
    ...
    type=str,
    default="/home/mil/kasuga/kaolin_1217/kaolin/examples/ImageRecon/Pixel2Mesh_pyredner/log/0125kujira_car_roughness_sample_roughrange/model/material_estimator_epoch53.pth",
    help='optimizer_path')
    ...
    def validate(self):
        ...
        with torch.no_grad():
            ...
            for i in range(args.val_batchsize):
                ...
                out_roughness_batch = out_materials_batch[:, 0].unsqueeze(1)
